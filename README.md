...
- Fourteen public, hand-written cases are a small, exposed test set. There is no hidden split, contamination control, or statistically supported model ranking.
